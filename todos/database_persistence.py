...
class DatabasePersistence:
    ...
    def update_list_by_id(self, list_id, new_title):
        ...
        logger.info("Executing query: %s with list_id: %s and %s", query, list_id, new_title)
        with self._database_connect() as conn:
            with conn.cursor(cursor_factory=DictCursor) as cursor:
    ...
    def delete_todo_from_list(self, list_id, todo_id):
        ...
        logger.info("Executing query: %s with todo ID: %s and list_id: %s", query, todo_id, list_id)
        with self._database_connect() as conn:
            with conn.cursor(cursor_factory=DictCursor) as cursor:
    ...
    def update_todo_status(self, list_id, todo_id, new_status):
        ...
        logger.info("Executing query: %s with todo_id: %s list_id: %s status: %s", query, todo_id, list_id, new_status)
        with self._database_connect() as conn:
            with conn.cursor(cursor_factory=DictCursor) as cursor:
